...
{.reveal(when="blank-0")} و هذا يبدو جليّا عند النظر لعدَّة بندولات معا. فدعنا نضيف ثلاص بندولات خلف البندول الأول، و كل منها سيختلف زاويته الابتدائية بمقدار ضئيل جدا لا نكاد نراه (أقل من ٠.١°).
